 ...
 * {@link com.com.thetransactioncompany.jsonrpc2.JSONRPC2Error#INVALID_PARAMS}
 * exception is thrown.
 *
 * <p>There are two concrete classes:
 *
 * <ul>
 *     <li>The {@link com.com.thetransactioncompany.jsonrpc2.util.PositionalParamsRetriever} 
 *         class is for extracting <em>positional parameters</em> (packed in a
 *	   JSON array).
 *     <li>The {@link com.com.thetransactioncompany.jsonrpc2.util.NamedParamsRetriever} 
